...
D_b1 = tf.Variable(tf.random_normal([n_hidden], stddev=0.01))
...
train_D = tf.train.AdamOptimizer(learning_rate=learning_rate).minimize(
    -loss_D, var_list=D_var_list)
train_G = tf.train.AdamOptimizer(learning_rate=learning_rate).minimize(
